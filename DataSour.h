...
void __fastcall DecRefCount()
    {FRefCount--;}
public:
/*Проверка допустимости притягивания точки объекта obj1 к объекту obj2
 Возвращает приоритет притягивания от 0 до 255 255 - максимальный,
 0 отсутствие притягивания
*/
