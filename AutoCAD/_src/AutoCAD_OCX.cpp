...
// File generated on 12.11.2017 7:43:59 from Type Library described below.
...
// HelpString: AutoCAD 2010 Type Library
// DepndLst: 
...
//   Hint: Symbol 'Update' renamed to '_Update'
//   Hint: Symbol 'Update' renamed to '_Update'
//   Error creating palette bitmap of (TAcadAcCmColor) : Server C:\Program Files\AutoCAD 2010\acad.exe /Automation contains no icons
//   Error creating palette bitmap of (TAcadSortentsTable) : Server C:\Program Files\AutoCAD 2010\acad.exe /Automation contains no icons
//   Error creating palette bitmap of (TAcadTableStyle) : Server C:\Program Files\AutoCAD 2010\acad.exe /Automation contains no icons
//   Error creating palette bitmap of (TAcadMLeaderStyle) : Server C:\Program Files\AutoCAD 2010\acad.exe /Automation contains no icons
//   Error creating palette bitmap of (TAcadDatabase) : Server C:\Program Files\AutoCAD 2010\acad.exe /Automation contains no icons
//   Error creating palette bitmap of (TAcadSecurityParams) : Server C:\Program Files\AutoCAD 2010\acad.exe /Automation contains no icons
//   Error creating palette bitmap of (TAcadLayerStateManager) : Server C:\Program Files\AutoCAD 2010\acad.exe /Automation contains no icons
//   Error creating palette bitmap of (TAcadDocument) : Server C:\Program Files\AutoCAD 2010\acad.exe /Automation contains no icons
// ************************************************************************ //
